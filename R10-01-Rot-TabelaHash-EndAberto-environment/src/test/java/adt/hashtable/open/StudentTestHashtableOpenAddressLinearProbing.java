...
public class StudentTestHashtableOpenAddressLinearProbing {
    ...
    public void testIndexOf(){
        ...
        for (int i = 0; i < 10; i++) {
            ...
            table2.insert(null);
            table2.insert(new HashtableElement(i));
            assertEquals(i, table2.indexOf(new HashtableElement(i)));
        }
        ...
        for (int i = 0; i < 10; i++) {
            ...
            table1.insert(null);
            table1.insert(new HashtableElement((i * 10) + 2));
            assertEquals(((2 + i) % 10), table1.indexOf(new HashtableElement((i * 10) + 2)));
        }
    }
