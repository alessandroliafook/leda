...
public class StudentBSTTest {
    ...
    public void testinho(){
        assertTrue(-1 == tree.height());
        tree.insert(1);
        assertTrue(0 == tree.height());
        tree.insert(2);
        assertTrue(1 == tree.height());
        tree.insert(3);
        assertTrue(2 == tree.height());
        tree.insert(-1);
        assertTrue(2 == tree.height());
        tree.insert(-2);
        assertTrue(2 == tree.height());
    ...
    public void testOrder(){
        ...
        Integer[] array = {96, 84, 42, 36, 57, 87, 89, 97};
    ...
    public void testSucessorPredecessor() {
        ...
        assertEquals(new Integer(5), tree.sucessor(0).getData());
        assertEquals(new Integer(-40), tree.predecessor(0).getData());


        tree.remove(5);
        tree.remove(-40);

        assertEquals(new Integer(6), tree.sucessor(0).getData());
    ...
    public void testRemove() {
        ...
        Random r = new Random();
        Set<Integer> elementsInTree = new TreeSet<>();
        Set<Integer> elementsRemoved = new TreeSet<>();

        for(int i = 0 ; i < 1000 ; i++){
            int val = r.nextInt();
            tree.insert(val);
            elementsInTree.add(val);
        }
        ...
        for(int i : lista){
            ...
            tree.remove(i);
            elementsInTree.remove(i);
            elementsRemoved.add(i);

            for(int j : elementsInTree){
                assertEquals(new Integer(j), tree.search(j).getData());
            }

            for(int j : elementsRemoved){
                assertEquals(NIL, tree.search(j));
            }
